let Card = ({obj})=>{
  ...
  return (
    <div className="card w-60 h-70 bg-white dark:bg-[#1e1e1e] dark:text-white shadow-[0_0_8px_-5px_rgba(0,0,0)] rounded-2xl overflow-hidden transition-shadow delay-250 duration-250 ease-in-out cursor-pointer hover:-translate-y-2 hover:shadow-[0_14px_28px_rgba(255,0,0,0.12)]">
      ...
      <div className="details p-4">
        <h1 className="text-[1.05rem] mb-1.2 text-[#222] dark:text-white font-150" >{name}</h1>
        <p className="text-[0.85rem] text-[#777] dark:text-white mb-2.5">{description}</p>
        <div className="info flex justify-between items-center text-[0.85rem] mt-2.5">
          <div className="rating text-amber-500"> <p>⭐ {rating}</p>
          </div>
          <div className="foodtiming text-[#555] dark:text-white font-bold"><p>{timing} mins</p></div>
